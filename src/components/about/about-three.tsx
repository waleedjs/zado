          ...
          <div className="col-xl-6 col-lg-6 col-md-8">
            <div className="tp-about-3-content">
              <p className="mb-30 tp_fade_bottom">
                ZADO is a creative studio focused on branding, web design, and motion experiences. We help brands express their identity through design that feels seamless, fluid, and alive.
              </p>
