...
export const metadata: Metadata = {
  title: "Zado - Creative digital marketing agency & software house",
  description: "Generated by create next app",
  publisher: "ZADO Digital Marketing Agency",
  icons: {
    icon: '/assets/img/logo/Zado Final Logo Design Black.png',
    shortcut: '/assets/img/logo/Zado Final Logo Design Black.png',
    apple: '/assets/img/logo/Zado Final Logo Design Black.png',
  },
  other: {
    "article:publisher": "https://www.facebook.com/zadoagency",
  },
};
